...
//    @Override
//    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain, @Valid @RequestBody UserUpdateDto requestBody) throws IOException, ServletException {
...
//                Optional<User> userEntity = userService.findByUsername(newUsername);
//            }
//            // 원본은 이거 한 줄
////            User userEntity = userService.findByUsername(username).get();
//
